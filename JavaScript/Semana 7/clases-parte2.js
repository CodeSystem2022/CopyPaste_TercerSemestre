...
/*Hoisting es un comportamiento en JavaScript donde las declaraciones de variables y funciones se mueven al principio del ámbito actual antes de que se ejecute el código. 
//Esto significa que, aunque una variable o función se declare más tarde en el código, se puede utilizar antes de su declaración debido a que ha sido "levantada" al principio del ámbito. 
...
class Empleado extends Persona{
    ...
    //Sobreescritura, modifica el comportamiento(método) de la clase padre
    nombreCompleto(){
...
//** OBJETO 1 **/
let persona1 = new Persona('Pedro', 'Martinez');
...
// Esto va a depender del tipo de objeto con el que estemos trabajando. Si estamos trabajando con una clase hija, el método que se ejecutará será el método de la clase hija.
